            ...
            <div className="stat-col">
              ...
              {transaction_details?.status === "pending" && (
                ...
                >
                  <i
                    className={`fas ${
                      loading ? "fa-spin fa-circle-notch" : "fa-recycle"
                    } `}
                  ></i>{" "}
                  {loading ? "Working..." : "Re Query"}
                </a>
              )}
            </div>
          </div>
