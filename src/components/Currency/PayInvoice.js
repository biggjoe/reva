...
import { Slide, DialogContent, Dialog, Divider, Collapse } from "@mui/material";
          ...
          <div className="login-pane px0 py0">
            ...
            <div className="flex flex-row px20 py10">
              <div className="flex flex-col spacer">
                ...
                <h3 className="mb0 pb0">
                  {modal.amount} {modal.currency.toUpperCase()}
                </h3>
              </div>
            ...
            <div className="nbx">
              ...
              >
                <AccordionSummary
                  ...
                  id="panel1bh-header"
                >
                  <h4 className="flex ">PAY WITH CRYPTO WALLET</h4>
                </AccordionSummary>
                <Divider />
                <AccordionDetails>
                  <div
                  ...
                  >
                    {!modal?.address && <ConnectWalletButton />}
                    {modal?.address && (
                      <Link href="/purchase">Use wallet on purchase page</Link>
                    )}
                  </div>
                </AccordionDetails>
              </Accordion>
                ...
                <AccordionDetails>
                  <div className="pxy10 break-word">
                    <p>
                      ...
                      into our presale address above and the click on the{" "}
                      <strong>&quot;I HAVE PAID&quot;</strong> button below to
                  ...
                  <div className="btn-div" style={{ opacity: 1 }}>
                    <button onClick={launchLogPay} className="buy_token_button">
                      I HAVE PAID
                    </button>
                  </div>
                </AccordionDetails>
